...
- - The project now includes dedicated modular backtests for all active models under `backtest/`. As additional models have
...
| USEQ      | 2009-12-16 → 2026-03-04 | 13.05% | 0.770  | -30.10% | -0.061    | -0.61%               |
...
- **USEQ Backtest Universe:** SCHB, XLG, SCHV, QQQ, RSP
- **USEQ Effective Start:** 2009-12-16 (based on combined ETF history + lookback warmup)
