...
def _write_excel_by_logic(df: pd.DataFrame, name: str) -> None:
    ...
    def _drop_redundant_columns(frame: pd.DataFrame, entry_logic: str, exit_logic: str) -> pd.DataFrame:
        drop_cols = []
...
def main() -> None:
    ...
    for ma_entry_buffer in ma_entry_buffers:
        part = sweep_combined_entry_exit_grid(
            ...
            exit_lengths=(30, 50, 90),
            ma_entry_buffer=ma_entry_buffer,
            ma_exit_buffer=0.0,
            donchian_entry_buffer=0.0,
            ...
            k_confirms_exit=(1, 2),
            enter_logics=("MA", "DONCHIAN", "AND", "OR"),
