...
class PMTLBacktestEngine:
    ...
    def __init__(self, main_ticker: str, start_date: str, end_date: str):
    ...
    def run_window_sweep(
        ...
        benchmark_annual = benchmark_rets.groupby(benchmark_rets.index.year).sum()
        annual_returns_all['benchmark'] = benchmark_annual
        monthly_returns_all['benchmark'] = benchmark_rets
        
        metrics = compute_metrics(benchmark_rets)
