...
def backtest_momentum(
    ...
    Args:
        ...
        score_mode: Momentum formula to use. Options:
            - "12m_minus_1m" (default): 12M return minus 1M return.
            - "blend_6_12": 50/50 blend of 6M and 12M returns.
            - "rw_3_6_9_12": Recency-weighted returns (3M/6M/9M/12M weighted 40/20/20/20).
    ...
    start_idx = max(min_lookback_months, vol_lookback if vol_adjusted else min_lookback_months)
