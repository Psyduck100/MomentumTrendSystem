...
q = (
    Query()
    .select("ticker", "name", "volume")
    .where(col("volume").greater_than(500000), col("type").equals("ETF")),
    col("aum").greater_than(20000000),
    col("average_volume_30d_calc").greater_than(500000),
)
