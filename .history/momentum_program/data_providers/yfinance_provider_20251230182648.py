...
def fetch_all_etfs(q, chunk=50):
    ...
    while True:
        ...
        try:
            ...
            # Treat missing page data as end-of-results (common when cookies expire or limits apply).
