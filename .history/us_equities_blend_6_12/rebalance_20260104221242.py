"""Monthly US Equities Momentum Rebalance Script (blend_6_12 strategy)
...
# Strategy Parameters
UNIVERSE_CSV = Path(__file__).parent.parent / "CSVs/US_equities.csv"
...
def download_prices(tickers: list[str], start_date: str = "2000-01-01") -> pd.DataFrame:
    ...
    print(
        f"Downloading price data for {len(tickers)} tickers from {start_date} to {today}..."
    )
...
def main():
    ...
    print("=" * 60)
    print("US EQUITIES MOMENTUM STRATEGY - MONTHLY REBALANCE (blend_6_12)")
    print("=" * 60)
