...
def export_results(results_df, annual_returns_all, config) -> None:
...
def main():
    ...
    results_df, annual_returns_all = engine.run_window_sweep(
        fallback=fallback,
    ...
    # Export results
    print(f"\n💾 Exporting Results...")
    export_results(results_df, annual_returns_all, ACTIVE_CONFIG)
