...
def run_backtest() -> None:
    ...
    for s in scenarios:
        ...
        print(
            f"{s['start']}->{s['end']} | vol_adj={s['vol_adj']}, score={s['score_mode']}, thr={thr_txt}, gap={s['rank_gap']}, abs={s['abs_filter']}@{s['abs_band']:.2%} | "
    ...
    with output_path.open("w") as f:
        ...
        for s in scenarios:
            ...
            f.write(f"Config: vol_adj={s['vol_adj']}, score={s['score_mode']}, thr={thr_txt}, gap={s['rank_gap']}, abs={s['abs_filter']}@{s['abs_band']:.2%}\n")
