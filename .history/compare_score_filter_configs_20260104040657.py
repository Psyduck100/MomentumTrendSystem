...
CONFIGS = [
    ...
    {"label": "12m_no_filter", "score_mode": "ret_12m", "filter": "none"},
    {"label": "12m_filter_6m", "score_mode": "ret_12m", "filter": "ret_6m"},
    {"label": "12m_filter_12m", "score_mode": "ret_12m", "filter": "ret_12m"},
    
    # blend_6_12 scoring with various filters
    {"label": "blend_no_filter", "score_mode": SCORE_MODE_BLEND_6_12, "filter": "none"},
    {"label": "blend_filter_6m", "score_mode": SCORE_MODE_BLEND_6_12, "filter": "ret_6m"},
    {"label": "blend_filter_12m", "score_mode": SCORE_MODE_BLEND_6_12, "filter": "ret_12m"},
]
...
def run_strategy(label: str, score_mode: str, filter_mode: str) -> dict:
