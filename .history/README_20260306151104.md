...
The momentum factor is a persistent historical premium observed in equities and assets. In MSCI's factor indexing through the decades the momentum factor is observed to have one of the strongest risk adjusted returns. Although the momentum premia has diminished over the past 2 decades, it is still very present. The most sucessful momentum approaches seem to Dual momentum (which is recently gaining traction) and cross-sectional. In studies it is also shown that supported with trend breakout systems this type of setup can have significant alpha. The motivation, thus, is to explore and backtest various systems, setups and compare metrics to find stable parameters.

Links: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2139210
https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2042750
https://cmtassociation.org/wp-content/uploads/2025/10/2025-DowWinner_A-Century-of-Profitable-Trends.pdf
https://www.msci.com/downloads/web/msci-com/research-and-insights/paper/factor-indexing-through-the-decades/factor-indexing-through-the-decades.pdf

Sources:
Dual Momentum Investing: An Innovative Strategy for Higher Returns with Lower Risk 1st Edition by Gary Antonacci
Chen, Linda H. and Jiang, George and Zhu, Xingnong, Do Style and Sector Indexes Carry Momentum? (August 28, 2011) https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2139210
Risk Premia Harvesting Through Dual Momentum
A CENTURY OF PROFITABLE TRENDS By Carlo Zarattini, CMT and Gary Antonacci https://cmtassociation.org/wp-content/uploads/2025/10/2025-DowWinner_A-Century-of-Profitable-Trends.pdf
