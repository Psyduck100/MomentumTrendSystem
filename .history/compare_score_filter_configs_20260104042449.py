...
def load_risk_free_band() -> pd.Series:
    """Load TB3MS and use the annualized yield directly as the band.

    TB3MS is quoted in annualized percent for that month (e.g., 5.15 = 5.15% annualized).
    For comparing to a 12M equity return, we use band = annualized_yield / 100.
    """
    ...
    tbill['rf_annual'] = tbill['TB3MS'] / 100.0
    return tbill['rf_annual']
