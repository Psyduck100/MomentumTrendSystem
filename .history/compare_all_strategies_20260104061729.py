...
print("\nKEY OBSERVATIONS:")
print("✓ UsEquities (locked) STILL wins: 13.28% CAGR + 0.92 Sharpe (lowest drawdown -16.43%)")
print("• SPY-gated approach achieves 12.14% CAGR + 0.91 Sharpe (moderate drawdown -21.59%)")
print("  └─ SPY momentum as gatekeeper prevents bad timing in US buckets")
print("• Layered (unconstrained) achieves 12.85% CAGR + 0.90 Sharpe (worst drawdown -28.13%)")
print("• GEM spy_default underperforms: 9.77% CAGR (122 bps lower)")
print("\nRECOMMENDATION:")
print("→ Primary: Keep UsEquities (locked) as main strategy")
print("→ Alternative: SPY-gated approach offers good risk-adjusted returns if you want more defensive mechanics")
