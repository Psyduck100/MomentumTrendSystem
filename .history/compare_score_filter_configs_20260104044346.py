...
CONFIGS = [
    ...
    {
        "label": "12m_filter_12m",
        "score_mode": "ret_12m",
        "filter": "ret_12m",
        "band_series": None,
    },
    {
        "label": "12m_filter_12m_excess_rf",
        "score_mode": "ret_12m",
        "filter": "ret_12m",
        "band_series": "rf_12m",
    },
    ...
    {
        "label": "blend_no_filter",
        "score_mode": SCORE_MODE_BLEND_6_12,
        "filter": "none",
        "band_series": None,
    },
    {
        "label": "blend_filter_6m",
        "score_mode": SCORE_MODE_BLEND_6_12,
        "filter": "ret_6m",
        "band_series": None,
    },
    {
        "label": "blend_filter_12m",
        "score_mode": SCORE_MODE_BLEND_6_12,
        "filter": "ret_12m",
        "band_series": None,
    },
    {
        "label": "blend_filter_12m_excess_rf",
        "score_mode": SCORE_MODE_BLEND_6_12,
        "filter": "ret_12m",
        "band_series": "rf_12m",
    },
...
def run_strategy(
    label: str, score_mode: str, filter_mode: str, band_series: pd.Series | None
) -> dict:
