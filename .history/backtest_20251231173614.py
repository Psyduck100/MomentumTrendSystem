...
def run_backtest() -> None:
            ...
            for rank_gap_setting in rank_gaps:
                for threshold in thresholds:
                    backtest_data = backtest_momentum(
                        ...
                        force_broad_us=cfg.strategy.force_broad_us,
                        broad_us_ticker=cfg.strategy.broad_us_ticker,
    ...
    print(
        "Columns: vol_adj, lookbackM, threshold, rank_gap, CAGR, Sharpe, MaxDD, Turnover"
    )
    for s in scenarios:
        o = s["overall"]
