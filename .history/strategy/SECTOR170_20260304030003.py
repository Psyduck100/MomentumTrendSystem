"""
Sector Rotation (Static 170D Momentum) - Modular Rebalance Module

Strategy:
- Universe: XLK, XLV, XLF, XLI, XLE, XAR (optimized set, XLY excluded)
...
DEFAULT_UNIVERSE = ("XLK", "XLV", "XLF", "XLI", "XLE", "XAR")
