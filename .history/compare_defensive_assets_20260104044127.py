...
# Use tickers with proven data coverage
tickers = ["SPTM", "SPY", "QQQ", "OEF", "IWD", "IEF"]
print(f"Universe: {len(tickers)} tickers")

# Create bucket map (all in equity bucket for ranking, IEF for defensive allocation)
bucket_map = {ticker: "US_Equities" for ticker in tickers}
