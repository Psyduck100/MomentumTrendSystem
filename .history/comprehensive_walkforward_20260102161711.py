...
GAP_CONFIGS = [
    ...
    {'Bonds': 0, 'Commodities': 0, 'Emerging_Markets': 0, 'International': 0, 'US_equities': 0, 'US_small_mid_cap': 0},
    {'Bonds': 1, 'Commodities': 1, 'Emerging_Markets': 1, 'International': 1, 'US_equities': 1, 'US_small_mid_cap': 1},
    {'Bonds': 3, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 2, 'US_small_mid_cap': 2},
    {'Bonds': 2, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 1, 'US_small_mid_cap': 1},
    {'Bonds': 3, 'Commodities': 1, 'Emerging_Markets': 1, 'International': 1, 'US_equities': 0, 'US_small_mid_cap': 0},
    {'Bonds': 1, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 3, 'US_small_mid_cap': 3},
...
def anchored_walkforward(tickers, bucket_map, start_year=2015, end_year=2025):
    ...
    for test_year in range(start_year + initial_train_years, end_year + 1):
        ...
        for i, config in enumerate(all_configs):
            ...
            train_metrics = run_backtest_config(tickers, bucket_map, train_start, train_end, config)
        ...
        test_metrics = run_backtest_config(tickers, bucket_map, test_start, test_end, best_config)
...
def rolling_walkforward(tickers, bucket_map, train_years=5, start_year=2015, end_year=2025):
    """
...
def main():
    ...
    anchored_results = anchored_walkforward(tickers, bucket_map, start_year=2015, end_year=2025)
    ...
    rolling5_results = rolling_walkforward(tickers, bucket_map, train_years=5, start_year=2015, end_year=2025)
    ...
    rolling4_results = rolling_walkforward(tickers, bucket_map, train_years=4, start_year=2015, end_year=22025)
