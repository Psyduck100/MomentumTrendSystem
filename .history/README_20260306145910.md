...
The momentum factor is a persistent historical premium observed in equities and assets. In MSCI's factor indexing through the decades the momentum factor is observed to have one of the strongest risk adjusted returns (https://www.msci.com/downloads/web/msci-com/research-and-insights/paper/factor-indexing-through-the-decades/factor-indexing-through-the-decades.pdf). Although the momentum premia has diminished over the past 2 decades, it is still very present. Several studies an
...
Chen, Linda H. and Jiang, George and Zhu, Xingnong, Do Style and Sector Indexes Carry Momentum? (August 28, 2011)
A CENTURY OF PROFITABLE TRENDS By Carlo Zarattini, CMT and Gary Antonacci
MSCI Factor Indexing Through the Decades
...
trimmed many backtest files -> kept most basic ones for demonstration as file directory was too messy
