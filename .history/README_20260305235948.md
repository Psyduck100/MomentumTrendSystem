...
**Universe:** VTI, IWF, IWD, QQQ, SPY (long-history proxy basket for US equity exposures)  
...
| USEQ      | 2002-07-31 → 2026-03-04 | 12.16% | 0.750  | -33.44% | 0.054     | 0.79%                |
...
- **USEQ Backtest Universe:** VTI, IWF, IWD, QQQ, SPY
