...
def run_walk_forward() -> None:
    ...
    # Walk-forward folds: expanding window, 1y test
    # For 2019-2024 (6 years): 4 folds with progressively longer training
    folds = [
        {"train_start": "2019-01-01", "train_end": "2020-12-31", "test_start": "2021-01-01", "test_end": "2021-12-31"},
        {"train_start": "2019-01-01", "train_end": "2021-12-31", "test_start": "2022-01-01", "test_end": "2022-12-31"},
        {"train_start": "2019-01-01", "train_end": "2022-12-31", "test_start": "2023-01-01", "test_end": "2023-12-31"},
        {"train_start": "2019-01-01", "train_end": "2023-12-31", "test_start": "2024-01-01", "test_end": "2024-12-31"},
    ]

    print(f"\nRunning {len(folds)} walk-forward folds (expanding window / 1y test)...")
