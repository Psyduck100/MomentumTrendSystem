...
# Note: Bucket names from CSVs folder
GAP_CONFIGS = [
    ...
    {'Bonds': 0, 'Commodities': 0, 'Emerging_Markets': 0, 'International': 0, 'US_equities': 0, 'US_small_mid_cap': 0},  # All agile
    {'Bonds': 1, 'Commodities': 1, 'Emerging_Markets': 1, 'International': 1, 'US_equities': 1, 'US_small_mid_cap': 1},  # All moderate
    {'Bonds': 3, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 2, 'US_small_mid_cap': 2},  # Sticky bonds
    {'Bonds': 2, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 1, 'US_small_mid_cap': 1},  # Moderate bonds, agile equities
    {'Bonds': 3, 'Commodities': 1, 'Emerging_Markets': 1, 'International': 1, 'US_equities': 0, 'US_small_mid_cap': 0},  # Agile equities, sticky bonds
    {'Bonds': 1, 'Commodities': 2, 'Emerging_Markets': 2, 'International': 2, 'US_equities': 3, 'US_small_mid_cap': 3},  # Sticky equities, agile bonds
    {'Bonds': 2, 'Commodities': 1, 'Emerging_Markets': 1, 'International': 1, 'US_equities': 0, 'US_small_mid_cap': 1},  # Mixed agility
]
...
def generate_configs() -> List[Dict[str, Any]]:
    ...
    configs = []
    for score_mode, filter_cfg, gap_cfg in product(SCORE_MODES, FILTER_MODES, GAP_CONFIGS):
        configs.append({
