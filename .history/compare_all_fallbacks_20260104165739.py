...
print("-" * 100)
print(f"{'Defensive Asset':<20} {'Type':<6} {'Window':<8} {'CAGR':<10} {'Sharpe':<10} {'MaxDD':<10}")
print("-" * 100)

print(f"{'CASH (0%)':<20} {cash.iloc[0]['type']:<6} {int(cash.iloc[0]['window']):<8} {cash.iloc[0]['cagr']:>8.2%}  {cash.iloc[0]['sharpe']:>8.3f}  {cash.iloc[0]['max_drawdown']:>8.2%}")
print(f"{'TB3MS (1.73% avg)':<20} {tb3ms.iloc[0]['type']:<6} {int(tb3ms.iloc[0]['window']):<8} {tb3ms.iloc[0]['cagr']:>8.2%}  {tb3ms.iloc[0]['sharpe']:>8.3f}  {tb3ms.iloc[0]['max_drawdown']:>8.2%}")

if has_ief and ief is not None:
    print(f"{'IEF (bonds)':<20} {ief.iloc[0]['type']:<6} {int(ief.iloc[0]['window']):<8} {ief.iloc[0]['cagr']:>8.2%}  {ief.iloc[0]['sharpe']:>8.3f}  {ief.iloc[0]['max_drawdown']:>8.2%}")
...
print("-" * 65)
print(f"{'CAGR':<20} {cash_ema100['cagr']:>14.2%} {tb3ms_ema100['cagr']:>14.2%} {tb3ms_ema100['cagr']-cash_ema100['cagr']:>14.2%}")
print(f"{'Sharpe Ratio':<20} {cash_ema100['sharpe']:>14.3f} {tb3ms_ema100['sharpe']:>14.3f} {tb3ms_ema100['sharpe']-cash_ema100['sharpe']:>14.3f}")
print(f"{'Max Drawdown':<20} {cash_ema100['max_drawdown']:>14.2%} {tb3ms_ema100['max_drawdown']:>14.2%} {tb3ms_ema100['max_drawdown']-cash_ema100['max_drawdown']:>14.2%}")
