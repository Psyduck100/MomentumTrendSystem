...
def run_walk_forward() -> None:
    ...
    print("\n" + "=" * 100)
    print("WALK-FORWARD RESULTS (2019-2024, expanding window / 1y test, 4 folds)")
    ...
    print("\n" + "=" * 100)
    print(f"Top 10 combos by median Sharpe (across {len(folds)} folds, 2021-2024 test years):")
    print("=" * 100)
