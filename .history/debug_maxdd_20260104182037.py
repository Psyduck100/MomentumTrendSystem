...
weekly_ema100 = weekly_results[
    (weekly_results["type"] == "EMA") & (weekly_results["window"] == 100)
]
biweekly_ema100 = biweekly_results[
    (biweekly_results["type"] == "EMA") & (biweekly_results["window"] == 100)
]
