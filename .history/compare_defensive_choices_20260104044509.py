"""Compare blend_filter strategies with IEF vs TB3MS cash as defensive asset.

Tests:
1. blend_filter_12m + IEF
2. blend_filter_12m + TB3MS cash
3. blend_filter_12m_excess_rf + IEF
4. blend_filter_12m_excess_rf + TB3MS cash
"""
...
def run_strategy(
    ...
    print(f"Running {label}: score={score_mode} filter={filter_mode} defensive={defensive_symbol or 'cash'}")
