...
- `USEQ` uses `SCHB, XLG, SCHV, QQQ, RSP` plus `IEF`; combined history and lookback warmup bind the effective start.
...
Default backtest universe: `SCHB, XLG, SCHV, QQQ, RSP` (defensive: `IEF`)
