...
def main() -> None:
    ...
    roll_mdd_on = _rolling_max_drawdown(run_gap1_no_xly_def_on.daily["ret"], window=window_3y)
    roll_mdd_off = _rolling_max_drawdown(run_gap1_no_xly_def_off.daily["ret"], window=window_3y)
