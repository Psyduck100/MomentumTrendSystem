...
def main() -> None:
    ...
    bench_metrics = _buy_hold_metrics(benchmark_prices.loc[result.daily.index.min() : result.daily.index.max()])
    ...
    print(
        ...
        f"| MaxDD: {bench_metrics['maxdd']:.2%} | Total: {bench_metrics['total_return']:.2%}"
    )
