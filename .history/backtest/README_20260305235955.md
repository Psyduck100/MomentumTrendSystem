...
- `USEQ` uses `VTI, IWF, IWD, QQQ, SPY` plus `IEF`; combined history and lookback warmup bind the effective start.
...
Default backtest universe: `VTI, IWF, IWD, QQQ, SPY` (defensive: `IEF`)
