...
Evaluation windows: Four sequential 6-year spans (2001→2007 ... 2019→2025)
followed by eight sequential 3-year spans (2001→2004 ... 2022→2025).
...
def build_custom_windows(ranges: list[tuple[str, int, int]]) -> list[tuple[str, str, str]]:
    windows: list[tuple[str, str, str]] = []
    for prefix, start_year, end_year in ranges:
        label = f"{prefix}_{start_year}_{end_year}"
