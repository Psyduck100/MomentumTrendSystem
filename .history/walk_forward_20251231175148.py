...
def run_walk_forward() -> None:
    ...
    folds = [
        {"train_start": "2019-01-01", "train_end": "2020-12-31", "test_start": "2021-01-01", "test_end": "2022-12-31"},
        {"train_start": "2019-01-01", "train_end": "2021-12-31", "test_start": "2022-01-01", "test_end": "2023-12-31"},
        {"train_start": "2019-01-01", "train_end": "2022-12-31", "test_start": "2023-01-01", "test_end": "2024-12-31"},
    ]
                ...
                for threshold in thresholds:
                    ...
                    for fold_idx, fold in enumerate(folds, 1):
                        ...
                        if backtest_data["overall_returns"].empty:
                            print(f"  [Fold {fold_idx} {fold['test_start'][:4]}] vol_adj={vol_flag}, lookback={lookback}M, gap={rank_gap_setting}: NO DATA")
                            continue
    ...
    print("\n" + "=" * 100)
    print(f"Top 15 combos by median Sharpe (across {len(folds)} folds, 2021-2024 test periods):")
    print("=" * 100)
